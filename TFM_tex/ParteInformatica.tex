...
Los modelos se van a entrenar con el conjunto de entrenamiento y se evaluará con los datos del conjunto de test. Esta división de los datos se realiza para tener un conjunto,
el de test, que no haya visto el modelo durante el entrenamiento para evaluar el rendimiento
real del modelo para datos que aún no ha visto. Esta práctica se utiliza comúnmente para evitar
el sobreentrenamiento de la red. La división de 90/10 es adecuada para nuestro conjunto de datos porque disponemos de una cantidad muy grande de datos (126.109 imágenes).
