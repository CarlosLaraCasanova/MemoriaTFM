...
El trabajo requerido para realizar esta parte del TFG se ha dividido en cuatro fases:
\begin{itemize}
...
\textcolor{red}{Aquí deberías poner un equeño repaso de los fundamentos teóricos necesarios para entender el trabajo, un párrafo que introduzca el capítulo.}

\textcolor{red}{Por otra parte, haría varios cambios en la estructura de los fundamentos teóricos:}
\begin{itemize}
    \item \textcolor{red}{Primero, en aprendizaje automático, introduciría el concepto en un primer párrafo y, }
