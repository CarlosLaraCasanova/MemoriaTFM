...
\usepackage[table]{xcolor} % agregar al preámbulo
...
\newcommand{\miTitulo}{Mejora de la Explicabilidad en Modelos de Clasificación de Lesiones Cancerosas en Biopsias de Próstata mediante Técnicas XAI\xspace}
...
\newcommand{\miFacultad}{ETS de Ingenierías Informática y de Telecomunicación}
